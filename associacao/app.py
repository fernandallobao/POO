...
if __name__ == "__main__":
    ...
    aluno2.matricula = input('Informe a matrícula do 2º aluno: ')
    ...
    #instanciar o curso 2
    curso2 = Curso('',0,'')

    curso2.nome = input('Informe o nome do curso: ')
    curso2.duracao = int(input('Informe a duracao do curso: '))
    curso2.turno = input('Informe o turno do curso: ')
    # print(curso1.nome)
    ...
    print(f'\nAluno {aluno1.nome}, de matrícula {aluno1.matricula} está inscrito no curso {aluno1.listar_cursos()}.')
    print(f'Aluno {aluno2.nome}, de matrícula {aluno2.matricula} está inscrito no curso {aluno2.listar_cursos()}.')
    print(f'\nNo curso {curso1.nome} estão matriculados os alunos: {curso1.listar_alunos()}')
